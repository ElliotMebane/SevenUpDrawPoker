...
/// <summary>
/// In Seven-Up, Flush beats Full House so we just switched those two in this game
/// </summary>
public class HandRankerSevenUpDrawPoker
{
    public HandRankerSevenUpDrawPoker()
    {
        // empty
    }
    ...
    public static int GetHandRank( Hand pHand1, Hand pHand2 )
    {
        ...
        // Manual manipulation for No Winner (-2 converted to Tie (0) )
        if ( tCompareResults == -2 )
        {
            tCompareResults = 0;
        }
